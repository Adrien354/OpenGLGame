...
int main()
{
	...
	// -------------------------
	Shader ourShader("../resources/shaders/modelLoading/modelLoading.vs", "../resources/shaders/modelLoading/modelLoading.fs");

	// load models
	// -----------
	Model ourModel("../resources/assets/backpack/backpack.obj");
    ...
    std::cout << "FPS: " << 1.0f / deltaTime << std::endl;
		...
		ourShader.setVec3("viewPos", 0.0f,  0.0f, 0.0f);
