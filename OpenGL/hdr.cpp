...
int main()
{
    ...
    // -------------------------
    Shader shader("../resources/shaders/hdr/lighting.vs", "../resources/shaders/hdr/lighting.fs");
    Shader hdrShader("../resources/shaders/hdr/hdr.vs", "../resources/shaders/hdr/hdr.fs");
